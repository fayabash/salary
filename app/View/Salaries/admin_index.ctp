<div class="salaries index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('net_fee'); ?></th>
			<th><?php echo $this->Paginator->sort('employee_id'); ?></th>
			<th><?php echo $this->Paginator->sort('company_cost'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($salaries as $salary): ?>
	<tr>
		<td><?php echo h($salary['Salary']['id']); ?>&nbsp;</td>
		<td><?php echo h($salary['Salary']['date']); ?>&nbsp;</td>
		<td><?php echo h($salary['Salary']['net_fee']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($salary['Employee']['name'], array('controller' => 'employees', 'action' => 'view', $salary['Employee']['id'])); ?>
		</td>
		<td><?php echo h($salary['Salary']['company_cost']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $salary['Salary']['id']), null, __('Are you sure you want to delete # %s?', $salary['Salary']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
